...
export function ButtonLink({
  ...
  return (
    <a
      href={href}
      className={`type-button inline-flex min-h-11 items-center justify-center gap-2 rounded-md border px-5 py-2.5 transition-colors focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-orange ${styles[variant]}`}
    >
      {children}
